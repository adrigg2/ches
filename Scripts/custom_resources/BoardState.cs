...
{
    private SquareSituation[,] _zoneOfControl;
    private int[,] _board;
    private int _turn;
    private int _timeLeft;
    private bool _castling;

    public SquareSituation[,] ZoneOfControl { get => _zoneOfControl; }
    public int[,] Board { get => _board; }
    public int Turn { get => _turn; }
    public int TimeLeft { get => _timeLeft; }
    public bool Castling { get => _castling; }

    public BoardState(int[,] board, SquareSituation[,] zoneOfControl, int turn, bool castling, int timeLeft = 0)
    {
